		...
		return (
			<div>
				<section className="hero is-fullheight-with-navbar">
					...
					<section className="hero is-danger is-bold is-small">
						<div className="columns">
							...
							<div className="hero-body">
								<div className="container">
									...
									<p>
										...
										stressful, but looking back at it now I
										can only see how fortunate I was. I went
										to a private school that had world class
										systems in place to help me apply where
										I wanted. I had upperclassmen and
										mentors that knew the process and could
										guide me through with ease. I had all
										the support in the world from my friends
										and family.
									</p>
									<br />
									<p>
										But most people don’t have it that easy.
										There are millions of students out there
										who deserve an education better than the
										one they’re getting, and not for a lack
										of trying. It’s just much harder for
										them because they don’t have the same
										support systems that I was fortunate
										enough to have. One of those is having a
										mentor that can guide them through the
										application process and help them
										maximize the chances of being accepted.
										I want Ohana to be that for them—a
										platform for those who’ve been through
										the process to help those in need of
										guidance.
									</p>
									<br />
									<p>
										This starts with us helping students not
										only by talking about what our
										university is like, but also by helping
										them with the application itself
										(especially helpful for students
										applying abroad that have no idea what
										to do). It’s a way to give back to the
										community and help those less fortunate.
